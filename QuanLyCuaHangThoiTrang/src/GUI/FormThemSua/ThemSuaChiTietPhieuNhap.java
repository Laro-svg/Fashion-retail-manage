...
public class ThemSuaChiTietPhieuNhap extends javax.swing.JFrame {
    ...
    private void btnThemChiTietPhieuNhapMouseClicked() {
        if (checkEmpty()) {
            ...
            double dongia = Double.parseDouble(txGia.getText()) / 100000;
...
//            }
    ...
    private Boolean checkEmpty() {
        ...
        if (mssp.trim().equals("")) {
            ...
            try {
                ...
                return showErrorTx(txGia, "Đơn giá không hợp lệ (phải là số thực), Nhập theo định dạng ví dụ 7.000.000 đ -> 7000000");
            }
    ...
    private void initComponents() {
        ...
        btnChonSP.setIcon(new javax.swing.ImageIcon(getClass().getResource("/DTO/Assets/Icons/clothes_icon.png"))); // NOI18N
