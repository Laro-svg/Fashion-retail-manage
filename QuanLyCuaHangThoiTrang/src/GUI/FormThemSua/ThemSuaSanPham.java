...
public class ThemSuaSanPham extends javax.swing.JFrame {
    ...
    private void btnThemMouseClicked() {
        ...
        if(validateForm()){
            ...
            if (!masp.substring(0,3).equals(mahsp)) {
                JOptionPane.showMessageDialog(null, "Mã sản phẩm và Hãng sản phẩm phải trùng 3 kí tự đầu! Mời nhập lại!");
                return;
            }
